...
//                args: List[ExprTree]
//              ) =>
//            ch << Comment("MethodCall, " + obj.line)
//
...
//            ch << Comment("IntLit, " + expr.line)
//            ch << Ldc(value)
//
//          case StringLit(value: String) =>
//            ch << Comment("StringLit, " + expr.line)
//            ch << Ldc(value)
//
//          case True() =>
//            ch << Comment("True, " + expr.line)
//            ch << ICONST_1
//
//          case False() =>
//            ch << Comment("False, " + expr.line)
//            ch << ICONST_0
//
//          case id: Identifier =>
//            ch << Comment("Identifier, " + expr.line)
...
//
//          case This() =>
//            ch << Comment("This, " + expr.line)
//            ch << ALOAD_0
//
//          case punkt0New(tpe: Identifier) =>
//            ch << Comment("New, " + tpe.line)
//            ch << DefaultNew(tpe.value)
//
//          case Not(expr: ExprTree) =>
//            ch << Comment("Not, " + expr.line)
//            val trueLabel = ch.getFreshLabel("true")
//            val afterLabel = ch.getFreshLabel("after")
//            ch <<
//              compileExpr(expr, ch) <<
